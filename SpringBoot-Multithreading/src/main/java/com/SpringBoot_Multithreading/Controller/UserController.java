...
import com.SpringBoot_Multithreading.Service.UserService;
...
public class UserController {
    ...
    public CompletableFuture<ResponseEntity> findUsers() throws Exception {
        return userService.findAllUsers().thenApply(ResponseEntity::ok);
    }

    @GetMapping(value = "/thread-users",produces = "application/json")
